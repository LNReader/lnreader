...
const usePreferences = novelId => {
  let sort, filter, position, showGeneratedChapterNumber;
  ...
  if (novel) {
    ...
    showGeneratedChapterNumber = novel.showGeneratedChapterNumber;
  }

  return { sort, filter, position, showGeneratedChapterNumber };
};
