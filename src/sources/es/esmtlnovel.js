...
const baseUrl = 'https://es.mtlnovel.com';
...
const parseNovelAndChapters = async novelUrl => {
  ...
  let headers = new Headers({
    referer: 'https://es.mtlnovel.com/alltime-rank/',
    'User-Agent':
      "'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.116 Safari/537.36",
  });
    ...
    loadedCheerio('div.ch-list')
      ...
      .each(function () {
        ...
        chapterUrl = chapterUrl.replace(
          `https://es.mtlnovel.com/${novelUrl}`,
          '',
        );
...
const searchNovels = async searchTerm => {
  const searchUrl =
    'https://es.mtlnovel.com/wp-admin/admin-ajax.php?action=autosuggest&q=' +
    searchTerm +
    '&__amp_source_origin=https%3A%2F%2Fes.mtlnovel.com';
...
export default EsmtlNovelScraper;
