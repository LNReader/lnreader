...
const popularNovels = async page => {
  const url = baseUrl + 'novel-genre/novel/page/' + page;
  ...
  loadedCheerio('.page-item-detail').each(function () {
    const novelName = loadedCheerio(this).find('cm-manga-title > a').text();
    const novelCover = loadedCheerio(this).find('img').attr('src');
    const novelUrl = loadedCheerio(this).find('cm-manga-title > a').attr('href');
...
export default ZenxNovelScraper;