...
export const createBackup = async () => {
  try {
    ...
    await NativeZipArchive.zip(ROOT_STORAGE, CACHE_DIR_PATH + '/' + ZipBackupName.DOWNLOAD)
...
export const restoreBackup = async () => {
  try {
    ...
    await NativeZipArchive.unzip(CACHE_DIR_PATH + '/' + ZipBackupName.DOWNLOAD, ROOT_STORAGE);
